  ...
  return (
    <>
      <motion.section
        ...
        viewport={{ once: true }}
        id="features"
        className="min-h-screen py-6 px-4 mt-10 lg:mt-20 bg-[#FFFFFF]/80">
        <motion.div
        ...
        <motion.div
          ...
          <h2 className="font-bold text-4xl md:text-5xl 2xl:text-8xl font-fredoka text-[#0F172A] mb-4">
            One Platform. Every <span className="text-[#7186FF]">Need</span>{" "}
            Covered
          </h2>
          <p className="font-host-grotesk font-normal text-lg md:text-xl px-16 text-[#475569] max-w-3xl mx-auto">
            From records to results, ClassRecord unifies every school operation.
          </p>
        </motion.div>
